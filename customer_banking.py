...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate for savings account (in %): "))
    ...
    cd_interest = float(input("Enter the annual interest rate for CD account (in %): "))
